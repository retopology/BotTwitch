...
namespace RetopBot.ShazamFolder.Magic
{
    ...
    internal static class Signature
    {
        ...
        private static int GetSampleRateCode(int sampleRate)
        {
            switch (sampleRate)
            {
                case 8000: return 1; throw new NotSupportedException();
                case 16000: return 3; throw new NotSupportedException();
                case 32000: return 4; throw new NotSupportedException();
            }
            return 1;
        }
