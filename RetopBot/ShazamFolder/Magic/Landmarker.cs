//
using RetopBot.ShazamFolder.Magic;
using System;
...
namespace RetopBot.ShazamFolder.Magic
{
    ...
    internal class Landmarker
    {
        ...
        private static readonly float LogMinMagnitudeSquared = (float)Math.Log(MinMagnitudeSquared);
        ...
        {
            return 18 * 1024 * (1 - ((float)Math.Log(_analysis.GetMagnitudeSquared(stripe, bin)) / LogMinMagnitudeSquared));
        }
